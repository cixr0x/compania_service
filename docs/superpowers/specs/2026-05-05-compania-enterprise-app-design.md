...
- Stakeholder information is presented as a header/detail section. The header displays stakeholder name, stake percentage, recorded investment, entitled income, and balance. Recorded investment is the signed sum of the selected project/stakeholder transaction rows. Entitled income is calculated cost multiplied by stake percentage plus profit multiplied by stake percentage. Balance is entitled income minus recorded investment.
